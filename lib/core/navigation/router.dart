...
import 'package:smarty/Screens/AddDeviceScreen.dart';
...
import '../../features/devices/presentation/views/fence.dart';
  ...
  static Route<dynamic> generateRoutes(RouteSettings settings) {
    switch (settings.name) {
      ...
      case fence:
        return getPageRoute(
          settings: settings,
          view: Fence(device: settings.arguments as Device),
        );
      ...
      case settingsRoute:
        ...
        return getPageRoute(
          settings: settings,
          view:  AddDeviceScreen(device: settings.arguments as Device?),
        );

        case appSettings:
        return getPageRoute(
          settings: settings,
          view:  const AppSettings(),
        );

        case qRScanScreen:
        return getPageRoute(
          settings: settings,
          view: const QRScanScreen(),
        );
